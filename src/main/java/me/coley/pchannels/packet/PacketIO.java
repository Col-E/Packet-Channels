...
public class PacketIO {
	 ...
	 *
	 * @param channel
	 * 		Channel to read packets from.
	 * @param condition
	 * 		Loop condition lookup.
	 * @param delegator
	 * 		Delegator with registered {@link PacketHandler}s to handle incoming packets.
	 *
	 * @throws IOException
	 * 		When reading packets fails.
	 */
	...
	/**
	 * @param channel
	 * 		Channel to write the packet to.
	 * @param packet
	 * 		Packet to write.
	 *
	 * @throws IOException
	 * 		When serializing the packet fails, or when the channel cannot be written to.
	 */
