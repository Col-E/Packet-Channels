...
public abstract class Server
{
    ...
    /**
     * @throws IOException When a {@link ServerSocketChannel} cannot be opened and bound to the default port.
     */
     ...
     * @throws IOException When a {@link ServerSocketChannel} cannot be opened and bound to the  port.
     */
     ...
     *
     * @throws IOException When {@link ServerSocketChannel#accept()} fails.
     */
     ...
     *
     * @throws IOException When clients cannot be notified of server closure.
     */
     ...
     *
     * @param channel Client channel connection.
     */
